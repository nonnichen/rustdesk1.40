...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "🌈基于 Rustdesk, 🌀Support by Nonni"),
        ...
        ("verify_rustdesk_password_tip", "验证登录密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用远程控制服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，远程控制可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当远程控制窗口打开时允许连接"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将远程控制客户端升级至版本 {} 或更新版本！"),
