...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the NonniX network..."),
        ...
        ("Slogan_tip", "🌈Base on Rustdesk, 🌀Support by Nonni"),
        ...
        ("setup_server_tip", "Connected to Nonni`s Server"),
        ...
        ("doc_mac_permission", "https://rustdesk.nonni.cn/docs/"),
        ...
        ("doc_fix_wayland", "https://rustdesk.nonni.cn/docs/"),
        ...
        ("powered_by_me", "Support by Nonni"),
        ...
        ("floating_window_tip", "It helps to keep Remote Control background service"),
        ...
        ("About RustDesk", "About Remote Control"),
